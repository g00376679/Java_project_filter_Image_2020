...
public class BufferedImageProcessorTask implements Callable<Boolean> {
    ...
    public BufferedImageProcessorTask(BufferedImage output, File inputFile, String filterName, String outputPath) {
        this.output = output;
     ...
     *
     * @param output     BufferedImage output
     * @param inputFile  input file as a File
     * @param filterName filter name as String
     * @param outputPath output path as String
     ...
     * @param outputPath output path of the image
    ...
    /**
     * calls writeBufferedImageToOutputFile method
     *
     * @return Boolean
     * @throws Exception
     */
